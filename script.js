...
function search(){
    ...
    var date = getDate();
    if (date === false){
        alert("Either this date does not exist or there is no picture for it. Please try a different date");
    }
...
function verifyDate(date){
    ...
    //check if picture exists for date (APOD starts june 16, 1995)
    if(parts[0] === "1995"){
    ...
    //checks if day exists in 30 day months
    ...
    //checks if day exists in february accounting for leap year
    if(parts[1] === "02"){
